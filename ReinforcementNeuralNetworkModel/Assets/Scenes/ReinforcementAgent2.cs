...
public class ReinforcementAgent2 : MonoBehaviour
{
    ...
    private const int WORK_POST_UNPAUSE = 3;
    ...
    private void ApplyAction()
    {
        ...
        {
            rBodies[1].velocity += new Vector2(50 * Time.deltaTime, 0f);
        }
    ...
    private void Worker()
    {
        ...
        while (quit == false)
        {
            try
            {
                ...
                {
                    reward = ((failDegree - pole1AngleDegree) / failDegree);
                    reward = reward * reward;
                }
                else if (pole1AngleDegree >= (360f - failDegree))
                {
                    reward = ((failDegree - (360 - pole1AngleDegree)) / failDegree);
                    reward = reward * reward;
                }
